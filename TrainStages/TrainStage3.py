...
# -------------------------
# Config (Stage-3 training)
# -------------------------
BASE_MODEL   = "merged_stage2"              # your merged Stage-2 base folder
repo_root = os.path.dirname(os.path.abspath(__file__))
repo_root = os.path.abspath(os.path.join(repo_root, ".."))
LORA_DIR     = os.path.join(repo_root, "LoraAdapters")
os.makedirs(LORA_DIR, exist_ok=True)
STAGE3_OUT   = os.path.join(LORA_DIR, "stage3-lora")                # output adapter dir (in LoraAdapters)
DATA_PATH    = os.path.join(repo_root, "Voices", "Stage3.jsonl")
...
model = get_peft_model(model, stage3_config)
...
trainer.train()
model.save_pretrained(STAGE3_OUT)
