...
# Merge Stage-3: attach `stage3-lora` onto `merged_stage2` and produce `merged_stage3`.
BASE_MODEL = LORA_ROOT / "merged_stage2"
STAGE3_ADAPTER = LORA_ROOT / "stage3-lora"

MERGED_OUTPUT = LORA_ROOT / "merged_stage3"
...
# -------------------------
print("[INFO] Attaching Stage-3 adapter and merging into base...")
